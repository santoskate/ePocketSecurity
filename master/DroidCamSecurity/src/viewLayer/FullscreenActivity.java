...
import viewLayer.util.SystemUiHider;
                ...
                .setOnVisibilityChangeListener(new SystemUiHider.OnVisibilityChangeListener() {
                    ...
                    public void onVisibilityChange(boolean visible) {
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB_MR2) {
                            ...
                            if (mControlsHeight2 == 0) {
                                mControlsHeight2 = controlsView2.getHeight();
                            }
                            if (mShortAnimTime == 0) {
                            ...
                            controlsView2.animate()
                            .translationY(visible ? 0 : -mControlsHeight2)
                            .setDuration(mShortAnimTime);
                        } else {
                            ...
                            controlsView2.setVisibility(visible ? View.VISIBLE : View.GONE);
                        }
